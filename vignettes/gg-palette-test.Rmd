...
vignette: >
  %\VignetteIndexEntry{ggsnes palette demo}
...
```{r}
g_points + scale_color_discrete_snes(palette = "test")
...
```{r}
g_points + scale_color_discrete_snes(palette = "test", extend = TRUE)
...
ggplot(points, aes(x, y, col = assessment)) + geom_point() + scale_color_opinionated_snes(palette = "test")
```
